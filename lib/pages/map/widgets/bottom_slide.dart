import 'package:ruber/models/user.dart';
import 'package:ruber/pages/map/widgets/at_destination.dart';
import 'package:ruber/pages/map/widgets/confirm_ride.dart';
import 'package:ruber/pages/map/widgets/driver_on_the_way.dart';
import 'package:ruber/pages/map/widgets/in_motion.dart';
import 'package:ruber/pages/map/widgets/select_ride.dart';
import 'package:ruber/pages/map/widgets/take_a_ride.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedContainer(
      ...
      padding: const EdgeInsets.only(
          bottom: AppTheme.elementSpacing, top: AppTheme.elementSpacing),
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: AppTheme.appBlack.withOpacity(.1),
            spreadRadius: 6,
            blurRadius: 6,
          )
        ],
                                    ...
                                    leading: Column(
                                      ...
                                      children: [
                                        Icon(Icons.place_outlined,
                                            color: AppTheme.appblue, size: 18),
                                      ],
                                    ),
                                    onTap: () {
